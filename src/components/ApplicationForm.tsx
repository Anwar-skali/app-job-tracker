  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.formGroup}>
        ...
        <TouchableOpacity
          style={[styles.input, styles.filePickerButton]}
          onPress={async () => {
            try {
              ...
              Alert.alert(
                'Error',
                error instanceof Error ? error.message : 'Failed to pick document. Please try again.',
                [{ text: 'OK' }]
              );
            }
          }}
        ...
        >
          <Text style={formData.resumeFileName ? styles.filePickerText : styles.filePickerPlaceholder}>
            {formData.resumeFileName || 'Tap to upload resume (PDF, DOC, DOCX)'}
          </Text>
        </TouchableOpacity>
        {formData.resumeFileName && (
          <View style={styles.fileInfoContainer}>
            <Text style={styles.fileNameText}>📄 {formData.resumeFileName}</Text>
            <TouchableOpacity
              onPress={() => {
                setFormData((prev) => ({ ...prev, resume: '', resumeFileName: '' }));
              }}
